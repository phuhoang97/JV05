...
function Form({
  ...
  // C-7: Khai báo state để lưu trữ các gtri trong ô input
  ...
  // C-10: Viết hàm handeChangeInput để lấy tất cả giá trị trong các ô input
  ...
  // C-13: viết handleSubmitForm để submit form và gửi state lên cho component cha
  ...
  // U-12: Sử dụng useEffect để hiển hiện dữ liệu ra cho ng dùng
  useEffect(() => {
